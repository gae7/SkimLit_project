...
For example, given the following **input** (note: all numerical symbols have been replaced with "@"):
...
The goal is to train a model that returns the following **output**:
